    ...
    <div class="slider-area ">
        ...
        <div class="container"> </div>
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                       <h4 class="card-title" style="text-align: center;"  ><i class="fa fa-home"></i> <hr> Admin compte</h4>
                        <form class="form p-t-20" id="loginform" method="POST" action="{{ route('admin.login.submit') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group m-b-0">
                                <div class="col-sm-12 text-center">
                                    Vous n'avez pas de compte?<a href="#" class="text-info m-l-5"><b>S'inscrire</b></a>
                                </div>
                            </div>
                        </form>
                    </div>
