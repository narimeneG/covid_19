						...
						@foreach ($infos as $info)
							<tr style="text-align: center;">
								...
								<td class="table-action">
									...
									<button class="btn btn-warning m-0" data-infoid="{{ $info->id }}" data-titre="{{ $info->titre }}" data-cont="{{ $info->contenu }}" data-sid="{{ $info->sou_id }}" data-pid="{{ $info->pro_id }}" data-lien="{{ $info->lien }}" data-date="{{ $info->date }}"  data-toggle="modal" data-target="#modal2"><i class="align-middle" data-feather="edit-2"></i></button>
